...
class NestedLinearLayout @JvmOverloads constructor(
    ...
    override fun onTouchEvent(ev: MotionEvent?): Boolean {
        ...
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> run {
                ...
                if (!beingDragged && kotlin.math.abs(lastMotionY - y) > touchSlop) {
            ...
            MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP -> {
                if (beingDragged) {
                    ...
                    if (kotlin.math.abs(initialVelocity) > minimumVelocity) {
                        flingWithNestDispatch(-initialVelocity)
                    }
                }
    ...
    private fun flingWithNestDispatch(velocityY: Int) {
