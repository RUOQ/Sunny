...
open class BasePopupWindow constructor(private val context: Context)
    : PopupWindow(context),ActivityAction,
    KeyboardAction,
    HandlerAction, ClickAction,PopupWindow.OnDismissListener{
