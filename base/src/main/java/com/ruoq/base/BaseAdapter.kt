...
import com.ruoq.base.action.ResourcesAction
...
abstract class BaseAdapter<VH : BaseAdapter<VH>.BaseViewHolder>(private val context: Context) :
    ...
    /**条目子view 点击监听 **/
    private val childClickListeners: SparseArray<OnChildClickListener>
            by lazy { SparseArray() }
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        //根据ViewHolder 绑定的位置和传入的位置进行对比
        //一般情况下这两个位置的值是相等的，但是有一种特殊情况，
        //在外层添加头部view的情况下，这两个位置的值是不相等的
    ...
    constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onLongClick(view: View): Boolean {
            ...
            listener?.let{
                return it.onChildLongClick(recyclerView, view, position)
            }
            return false
        }
